    ...
    return Container(
      ...
      Column(
        ...
        children: <Widget>[
          ...
          Text("Seu dinheiro sempre rendendo.", style: AppTheme.displayBlackBig, textAlign: TextAlign.center,),
          SizedBox(height: 18,),
          Text("Você está deixando de ganhar dinheiro sem um NuConta.", style: AppTheme.displayMiddle, textAlign: TextAlign.center,),
          SizedBox(height: 22,),
          InkWell(
            onTap: () {},
            child: Container(
              ...
              child: Text("COMEÇA A NUCONTA", style: AppTheme.displayPrimaryColor),
            ),
          ),
        ],
      ),
